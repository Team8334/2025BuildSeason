...
public class SubsystemManager {
  ...
  /**
   * Initializes all registered subsystems by calling their initialize method. This method should be
   * called once at the beginning of the program to set up all of the robot's subsystems.
   */
   ...
   * allow access to the list for the purpose of iterating over the list to perform actions on each
   * subsystem, such as performing periodic updates.
   *
